   ...
   <div class="datatabcontainer mt-4">
      <table class="tab" id="myTable">
         ...
         <tbody>
            ...
            <tr>
               <td>{{ $dossierStage->etudiant->nom_fr ?? 'N/A' }} {{ $dossierStage->etudiant->prenom_fr ?? '' }}</td>
               <td>{{ $dossierStage->type_dossier ?? 'N/A' }}</td>
               <td>
                  @if(isset($dossierStage->dossier_stage))
                  <a href="{{ Storage::url($dossierStage->dossier_stage) }}" target="_blank">Cliquez ici</a>
                  @else
                  N/A
                  @endif
               </td>
               <td>
                  @if(isset($dossierStage->rapport))
                  <a href="{{ Storage::url($dossierStage->rapport) }}" target="_blank">Cliquez ici</a>
                  @else
                  N/A
                  @endif
               </td>
