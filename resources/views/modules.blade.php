        ...
        <form action="{{ route('diplomes.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container2">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="exampleFormControlInput6" name="id_personnel">
                        <option selected disabled>Selectionner le chef de cette filière</option>
                        @foreach ($personnel as $person)
                        <option value="{{ $person->id }}">{{ $person->nom_personnel }}</option>
                        @endforeach
                    </select>
                </div>
